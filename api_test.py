...
def cookerAssemble(content):
    ...
    #print(minitemS)
    boat.save("C:/Users/Administrator/git/art0804/WebContent/images/cooker.jpg")
    print(minitemS, minitemK, minitemB, minitemD,"C:/Users/Administrator/git/art0804/WebContent/images/cooker.jpg")
    # imageA.paste(imageC)
    # plt.show()
if __name__ == '__main__':
    #print("aaaaaaaaaa")
    cookerAssemble(sys.argv[1])
