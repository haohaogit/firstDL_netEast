...
def generateScarv(rgbs, packNum, imageAName, time):
    ...
    for j in range(colorNum):
        ...
        # images.append(Image.fromarray(imageAArrayTemp))
        images.append(imageAArrayTemp)
...
if __name__ == '__main__':
    # generateScarv(
    #     "175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,175,0,0,0,123,0,0,123,0",
    #     3, "D:/20170602/PycharmProjects/firstDL_netEast/artgene/3Colors.jpg", "637733")
