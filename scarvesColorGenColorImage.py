...
def generateScarv(rgbs, packNum, imageAName,timeid):
    ...
    imageAArrayTemp.save("C:/apache-tomcat-7.0.53/wtpwebapps/art0804/image/fabric" + "_" +timeid+ ".jpg")
    imageAArrayTemp.save("C:/apache-tomcat-7.0.53/wtpwebapps/art0804/image/fabricColor" + "_" + timeid + ".jpg")
    imageAArrayTemp.save("C:/apache-tomcat-7.0.53/wtpwebapps/art0804/image/fabricTexture" + "_" + timeid + ".jpg")
    imageAArrayTemp.save("C:/apache-tomcat-7.0.53/wtpwebapps/art0804/image/fabricPart" + "_" + timeid + ".jpg")
