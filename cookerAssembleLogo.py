...
def cookerAssembleLogo(content,r,g,b, materialfile,logofile,timeid):
    print("Logoimg1111  ")
    ...
    imagelogo = Image.open(logofile)
    imagelogo = imagelogo.resize((180, 100))
    ...
    r,g,b,a = imagelogo.split()
    boat.paste(imagelogo, (0,0), mask = a)
...
if __name__ == '__main__':
    # cookerAssembleLogo("A2,B2,C1,D2", 34,22,66, "D:/20170602/PycharmProjects/firstDL_netEast/artgene/M22.jpg","D:/20170602/PycharmProjects/firstDL_netEast/artgene/LOGO4.png","1508845993995")
    cookerAssembleLogo(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5], sys.argv[6],sys.argv[7])