...
def generateScarv(rgbs, packNum, imageAName, materiafile, frameFile,timeid):
	...
	r,g,b,a = imagebiankuang.split()
	imgBlend.paste(imagebiankuang, (0,0), mask = a)
	#plt.imshow(imgBlend)
	#imageA.paste(imageC)
	#plt.show()
	# imgBlend.save(imageAName+"Frame"+".png")
...
if __name__ == '__main__':
	...
	generateScarv(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6])